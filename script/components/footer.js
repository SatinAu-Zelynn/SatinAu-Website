...
class SiteFooter extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <footer>
        <p>
            <span id="build-info"style="vertical-align: middle"></span>
            <iframe src="https://status.satinau.cn/badge?theme=light" width="250" height="30" frameborder="0" scrolling="no" style="color-scheme: normal; vertical-align: middle; margin-right: -80px;"></iframe>
            <br>
